    ...
    <div className="flex flex-col min-h-screen bg-[#FFFFFF] pt-[72px]">
      <section className="flex-grow w-full border-b border-black">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] h-full min-h-[calc(100vh-72px)]">
          ...
          <div className="p-0 bg-[#FFFFFF] text-black flex flex-col justify-start">
            ...
            {/* PRINCIPLES */}
            <div className="p-8 md:p-16 border-b border-black">
              <h2 className="text-sm font-black tracking-widest uppercase mb-8"><span className="font-sans font-light">[</span> CORE_PRINCIPLES <span className="font-sans font-light">]</span></h2>
            ...
            <div className="p-8 md:p-16">
              <h2 className="text-sm font-black tracking-widest uppercase mb-12"><span className="font-sans font-light">[</span> EVENT_LOG <span className="font-sans font-light">]</span></h2>
