...
const bentoData = [
  ...
  },
  {
    ...
    longFeatures: [
      ...
      { name: "Club Store Prep & Fulfillment", desc: "For Costco, Sam's Club, and BJ's, we design and build the pallet planogram, pack to retailer spec (case counts, Ti-Hi, display-ready configurations), and coordinate factory-direct delivery routes that keep landed cost low." }
    ]
  }
];
              ...
              <form onSubmit={handleSubmit} className="space-y-8 max-w-2xl w-full mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="flex flex-col gap-3">
                    ...
                    <input type="text" id="name" name="name" className="border-2 border-black bg-white text-black py-4 px-4 outline-none focus:bg-black focus:text-white transition-colors font-mono text-sm" placeholder="Jane Doe" required />
                  </div>
                  <div className="flex flex-col gap-3">
                    <label htmlFor="email" className="text-xs font-black tracking-widest uppercase text-black">EMAIL</label>
                    <input type="email" id="email" name="email" className="border-2 border-black bg-white text-black py-4 px-4 outline-none focus:bg-black focus:text-white transition-colors font-mono text-sm" placeholder="jane@company.com" required />
                  </div>
                </div>

                <div className="flex flex-col gap-3">
                  <label htmlFor="company" className="text-xs font-black tracking-widest uppercase text-black">ORGANIZATION</label>
                  <input type="text" id="company" name="company" className="border-2 border-black bg-white text-black py-4 px-4 outline-none focus:bg-black focus:text-white transition-colors font-mono text-sm" placeholder="Organization name" />
                </div>

                <div className="flex flex-col gap-3">
                  <label htmlFor="description" className="text-xs font-black tracking-widest uppercase text-black">MESSAGE</label>
                  <textarea id="description" name="description" rows={5} className="border-2 border-black bg-white text-black py-4 px-4 outline-none focus:bg-black focus:text-white transition-colors resize-none font-mono text-sm" placeholder="How can we help?" required></textarea>
                </div>
